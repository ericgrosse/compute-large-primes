<script>
  ...
  // Compute 10 prime numbers whose digit count is at least 5 and return them via console.log //
  ...
  if (allNumbersArePrime) {
    console.log('All 10 candidate prime numbers have been verified as prime.');
  }
  else {
